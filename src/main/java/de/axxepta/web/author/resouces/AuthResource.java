...
public class AuthResource{
	...
	@Operation(summary = "Register user", description = "Register user with JSON data that contain username and password", method = "POST", operationId = "#2_1")
	...
	@Operation(summary = "Login user", description = "Login user with JSON data that contain username and password", method = "POST", operationId = "#2_2")
	...
	@Operation(summary = "Change password", description = "Change password of current user", method = "GET", operationId = "#2_3")
	@ApiResponses({
	...
	@Operation(summary = "Get username", description = "Get username uf user from actual session", method = "GET", operationId = "#2_4")
	@ApiResponses({
	...
	@Operation(summary = "Check if logged user have an role", description = "Check if that logged user have the role specified", method = "GET", operationId = "#2_5")
	...
	@Operation(summary = "Logout", description = "Logout user session", method = "POST", operationId = "#2_6")
