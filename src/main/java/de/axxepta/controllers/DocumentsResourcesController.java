...
public class DocumentsResourcesController {
	...
	@Operation(summary = "List uploaded files", description = "Provide a map of uploaded files", method = "GET", operationId = "#6_1")
	...
	@Operation(summary = "Check if file exist", description = "Check if file specified by name exist", method = "GET", operationId = "#6_2")
	...
	@Operation(summary = "Upload file", description = "Upload file as an temporal one", method = "POST", operationId = "#6_3")
	@ApiResponses({
	...
	@Operation(summary = "Delete a file", description = "Delete an file from uploaded set", method = "DELETE", operationId = "#6_4")
	...
	@Operation(summary = "Retrieve file", description = "Retrieve file as an binary one", method = "GET", operationId = "#6_5")
